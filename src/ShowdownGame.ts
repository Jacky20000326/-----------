...
import { Player } from "./ShowdownPlayer.js";
import { GameTemplate} from "./model/Game.js";
export class Game extends GameTemplate<Player,Card>{

    private currTableCard:{Card,player:Player}[] = []
    private currRoundWinner:{Card,player:Player} = null
    constructor(playerList:Player[],duck:Duck){
